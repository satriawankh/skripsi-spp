...
if($_GET['act']=="input"){
	?>
          <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><strong>Tambah Data Siswa</strong></h3>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                ...
                                <div class="col-lg-6">
                                 ...
                                 <div class="form-group">
                                      ...
                                      <?php 
                                        ...
                                        echo "<option value='$rs[idp]'>$rs[tahun_ajaran]</option>";    
...
<input type="hidden" name="id" value="<?php echo $_GET['ids'] ?>" />
                                ...
                                <div class="form-group">
                                            ...
                                            <select class="form-control" name="ta">
  <?php 
                                        $sql1=mysql_query("select * from periode");
                                        while($r1s=mysql_fetch_array($sql1)){

                                        echo "<option value='$r1s[idp]'>$r1s[tahun_ajaran]</option>";    
...
<?php } ?>
                                        ...
                                        <div class="form-group">
                                            <label>Alamat</label>
                                            <textarea class="form-control" placeholder="Alamat" name="alamat" rows="2"><?php echo "$rs[alamat]"; ?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Kelas</label>
                                            <select class="form-control" name="kelas">
